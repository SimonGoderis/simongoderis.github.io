...
console.log("v1.8 - ek2024 update")
    ...
    var ls_player = localStorage.getItem('player_ek2024')
    if (player != null && ls_player == null) {
        // Als er nog niks in de localstorage opgeslaan is.
        localStorage.setItem('player_ek2024', player);
        console.log("New player added.")
    } else if (ls_player != null && player != ls_player && player != null) {
        localStorage.setItem('player_ek2024', player);
        console.log("Player changed.")
    }
    player = localStorage.getItem('player_ek2024');

    // API calls
    const link =
        'https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2Fe%2F2PACX-1vRs4KrshjFwolW1siOCpJ0ZmQTSnKEwqSKdxxB5wLEyVI2WTHN0UJXogeU72_VGoYXFRhXeUR8_PqV3%2Fpub%3Fgid%3D2116746882%26single%3Dtrue%26output%3Dcsv'
    const link_sb =
        'https%3A%2F%2Fdocs.google.com%2Fspreadsheets%2Fd%2Fe%2F2PACX-1vQzYBT8GC7Zrg65eP0jj4EilLYv83JM9Z11fl--86ifzbJ59KtaNeyRWrv1l5h9Sq1WmRJlK_UkEEIF%2Fpub%3Fgid%3D136616515%26single%3Dtrue%26output%3Dcsv'
